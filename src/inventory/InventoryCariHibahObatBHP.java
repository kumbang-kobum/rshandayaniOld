               ...
               try {
                  ...
                  if(rs.next()){
                      ...
                      if(sukses==true){
                          ...
                          sukses=jur.simpanJurnal(rs.getString("no_hibah"),"U","K037 BATAL HIBAH OBAT & BHP DI "+Sequel.cariIsi("select bangsal.nm_bangsal from bangsal where bangsal.kd_bangsal=?",rs.getString("kd_bangsal")).toUpperCase()+", OLEH "+akses.getkode());
                      }
