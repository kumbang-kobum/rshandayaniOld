...
public final class RMSkriningMPP extends javax.swing.JDialog {
    ...
    public RMSkriningMPP(java.awt.Frame parent, boolean modal) {
        ...
        tabMode=new DefaultTableModel(null,new Object[]{
            ...
            "Parameter 5","Parameter 6","Parameter 7","Parameter 8","Parameter 9","Parameter 10","Parameter 11","Parameter 12","Parameter 13","NIP","Nama Petugas"
        }){
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(TNoRM.getText().trim().equals("")){
            ...
            if(Sequel.menyimpantf("mpp_skrining","?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?","No.Rawat",16,new String[]{
                    ...
                    param8, param9, param10, param11, param12, param13,KdPetugas.getText()
                })==true){
                    tabMode.addRow(new String[]{
                        ...
                        param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12,param13,KdPetugas.getText(),NmPetugas.getText()
                    });
                    emptTeks();
            ...
            Map<String, Object> param = new HashMap<>(); 
                ...
                if(TCari.getText().equals("")){
                    Valid.MyReportqry("rptDataSkriningMPP.jasper","report","::[ Data Skrining Manajer Pelayanan Pasien ]::",
                        ...
                        "mpp_skrining.param13,mpp_skrining.nip,pegawai.nama "+
    ...
    */
    ...
    private void ganti() {
        ...
        if(Sequel.mengedittf("mpp_skrining","no_rawat=? and tanggal=?","no_rawat=?,tanggal=?,param1=?,param2=?,param3=?,param4=?,param5=?,param6=?,param7=?,param8=?,param9=?,param10=?,param11=?,param12=?,param13=?,nip=?",18,new String[]{
                TNoRw.getText(),Valid.SetTgl(TglSkrining.getSelectedItem()+""), param1, param2, param3, param4, param5, param6, param7,param8, param9, param10, param11, param12, param13,
